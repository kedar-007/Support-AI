...
import { ListIcon, ArrowRightIcon, ArrowUpIcon, CheckIcon, CornerLeftUpIcon, CornerUpLeftIcon } from "lucide-react";
                        ...
                        {conversations.results.map((conversation) => {
                            ...
                            return (
                                <Link
                                    ...
                                    <DicebearAvtar seed={conversation.contactSession._id} badgeImageUrl={countryFlagUrl} size={40} className="shrink-0" />
